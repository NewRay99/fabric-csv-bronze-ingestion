...
This document records the verified semantic-model changes between the archived `report v00` and `report v01` Power BI projects. It reconciles those changes with the draft [Statement of Work](06_Statement_of_Work.md) and the legacy [Measures Comparison Checklist](../measures_comparison_checklist.md).
...
| Version | Source archive | Semantic-model path inside archive | Table TMDL files |
|---|---|---:|---:|
| v00 | `report v00` | `Report/WMPP PILOT DASHBOARD (V13.1).SemanticModel/definition/` |  50 |
| v01 | `report v01` | `semantic_model __/SM_WMPP.SemanticModel/definition/` | 79 |

Later repository enhancements, including the separately documented `Closed_Date` calculated columns, are therefore outside this v00-to-v01 delta.
...
The semantic-model root directory was renamed from `SM test` to `SM Test v2`;

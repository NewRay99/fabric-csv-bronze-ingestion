...
1. `01_bronze_get_latest.ipynb`
2. `02_silver_formatter.ipynb`
...
`00a_rehydrate_archive_cfg.ipynb` first; only tables reported as genuinely
...
```text
python validate_core_pipeline.py
```
